                    ...
                    <div class="flex flex-col gap-4 text-right">
                        ...
                        <div class="mt-2 flex justify-end gap-2">
                            ...
                            <template v-if="campaign">
                                <!-- Withdraw Button (If Users Status is ACTIVE & Campaign In Active Period) -->
                                <button v-if="userStatus === 'ACTIVE' && new Date() < new Date(campaign.endDate)"
                                ...
                                <button v-else-if="new Date() < new Date(campaign.endDate) && userStatus !== 'ACTIVE'"
                                    @click="handleJoin"

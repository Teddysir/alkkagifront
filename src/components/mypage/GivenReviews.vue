...
<template>
    <section
        class="h-full bg-[#1e1e1e] border-2 border-blue-500/50 p-0 flex flex-col relative overflow-hidden group/section pixel-window shadow-none">

        <!-- Header Bar -->
        <div
            class="h-8 bg-blue-500/10 border-b border-blue-500/30 flex items-center px-4 justify-between shrink-0 relative z-10">
            <h3 class="text-blue-400 font-bold flex items-center gap-2 text-xs">
                <PixelText>> SENT_REVIEWS</PixelText>
            </h3>
            <div class="flex gap-2">
                <button @click="prevPage" :disabled="page === 0"
                    class="text-[10px] px-2 py-0.5 bg-gray-800 text-blue-400 border border-blue-900 disabled:opacity-30 hover:bg-gray-700 rounded-none">&lt;</button>
        ...
        <!-- Glow -->
        <div
            class="absolute inset-0 bg-blue-500/5 pointer-events-none group-hover/section:bg-blue-500/10 transition-colors z-0">
        </div>

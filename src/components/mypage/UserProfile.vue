...
<template>
    <div
        ...
        <div class="relative group cursor-pointer mb-6 mt-4 z-10" @click="showEditImageModal = true">
            ...
            <div
                class="w-24 h-24 rounded-full border-4 border-green-500 overflow-hidden bg-black/50 mx-auto shadow-[0_0_15px_rgba(74,222,128,0.3)] relative z-10">
            ...
            <button @click.stop="handleDeleteImage"
                class="absolute bottom-0 right-0 bg-red-500 text-white p-1 rounded-full text-xs hover:bg-red-600 border border-black z-30"
